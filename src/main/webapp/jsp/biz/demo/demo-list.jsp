...
<div id="ItemToolbar"  style="padding:5px;height:auto">
    ...
    <span style="float: right;margin-right: 10px;padding: 1px">
        <span>用户名:</span>
        <input lang="searchItem" name="name" style="line-height:19px;border:1px solid #ccc">
...
<div id="ItemEdit" title="用户"  style="width:500px;height:500px;top: 100px;padding: 10px;display: none" data-options="iconCls: 'icon-save',closed: true,modal: true,inline:true,buttons:[{text:'保存',iconCls:'icon-save',handler:function(){Item.input.submitForm()}},{text:'取消',iconCls:'icon-cancel',handler:function(){Item.input.close()}}]"></div>
