...
<form id="ItemForm" method="post">
    <table class="com_table" align="center">
        ...
        <tr>
            ...
            <td><select id="ItemOrg" name="orgId" class="com_input" data-options="textField:'text',valueField:'id',multiple:true,onlyLeafCheck:true,required:true"></select></td>
            <td></td>
        </tr>
        <tr>
            <td></td>
            <td><label>所有角色:</label></td>
            <td><select id="ItemRole" name="roleId" class="com_input" data-options="textField:'name',valueField:'id',multiple:true,onlyLeafCheck:true,required:true" style="width:173px;"></select></td>
            <td></td>
        </tr>
    </table>
</form>
